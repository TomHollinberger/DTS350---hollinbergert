...
#[] Change the legend title of the Shape legend to read “Species of Iris” instead of just “Species”.  pg28.5
...
#[] What happens if you also change the title of the color legend to “Species of Iris”?
